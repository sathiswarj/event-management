      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="font-serif text-2xl font-bold tracking-tight text-amber-500 mb-4">Elegance Events</h3>
            <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
              Crafting unforgettable moments through meticulous planning and extraordinary design. Your vision, perfectly executed.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              ...
              <li className="flex items-center">
                ...
                <span>hello@eleganceevents.com</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} Elegance Events. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
